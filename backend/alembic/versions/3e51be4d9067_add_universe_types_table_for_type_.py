...
def upgrade() -> None:
    ...
    op.drop_index('idx_killmails_character_time', table_name='killmails')
    op.create_index('idx_killmails_character_time', 'killmails', ['victim_character_id', 'time'], unique=False, postgresql_ops={'time': 'DESC'})
    op.drop_index('idx_killmails_corporation_time', table_name='killmails')
    op.create_index('idx_killmails_corporation_time', 'killmails', ['victim_corporation_id', 'time'], unique=False, postgresql_ops={'time': 'DESC'})
    op.drop_index('idx_killmails_system_time', table_name='killmails')
    op.create_index('idx_killmails_system_time', 'killmails', ['system_id', 'time'], unique=False, postgresql_ops={'time': 'DESC'})
    op.drop_index('idx_killmails_time_desc', table_name='killmails')
    op.create_index('idx_killmails_time_desc', 'killmails', ['time'], unique=False, postgresql_ops={'time': 'DESC'})
    op.drop_index('idx_killmails_value_desc', table_name='killmails')
    op.create_index('idx_killmails_value_desc', 'killmails', ['value'], unique=False, postgresql_ops={'value': 'DESC NULLS LAST'})
    op.drop_index('idx_price_history_date_desc', table_name='price_history')
    op.create_index('idx_price_history_date_desc', 'price_history', ['date'], unique=False, postgresql_ops={'date': 'DESC'})
    op.drop_index('idx_price_history_type_region_date', table_name='price_history')
    op.create_index('idx_price_history_type_region_date', 'price_history', ['type_id', 'region_id', 'date'], unique=False, postgresql_ops={'date': 'DESC'})
    op.drop_index('idx_system_activity_system_timestamp', table_name='system_activity')
    op.create_index('idx_system_activity_system_timestamp', 'system_activity', ['system_id', 'timestamp'], unique=False, postgresql_ops={'timestamp': 'DESC'})
    op.drop_index('idx_system_activity_timestamp_desc', table_name='system_activity')
    op.create_index('idx_system_activity_timestamp_desc', 'system_activity', ['timestamp'], unique=False, postgresql_ops={'timestamp': 'DESC'})
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_system_activity_timestamp_desc', table_name='system_activity', postgresql_ops={'timestamp': 'DESC'})
    op.create_index('idx_system_activity_timestamp_desc', 'system_activity', [sa.text('timestamp DESC')], unique=False)
    op.drop_index('idx_system_activity_system_timestamp', table_name='system_activity', postgresql_ops={'timestamp': 'DESC'})
    op.create_index('idx_system_activity_system_timestamp', 'system_activity', ['system_id', sa.text('timestamp DESC')], unique=False)
    op.drop_index('idx_price_history_type_region_date', table_name='price_history', postgresql_ops={'date': 'DESC'})
    op.create_index('idx_price_history_type_region_date', 'price_history', ['type_id', 'region_id', sa.text('date DESC')], unique=False)
    op.drop_index('idx_price_history_date_desc', table_name='price_history', postgresql_ops={'date': 'DESC'})
    op.create_index('idx_price_history_date_desc', 'price_history', [sa.text('date DESC')], unique=False)
    op.drop_index('idx_killmails_value_desc', table_name='killmails', postgresql_ops={'value': 'DESC NULLS LAST'})
    op.create_index('idx_killmails_value_desc', 'killmails', [sa.text('value DESC NULLS LAST')], unique=False)
    op.drop_index('idx_killmails_time_desc', table_name='killmails', postgresql_ops={'time': 'DESC'})
    op.create_index('idx_killmails_time_desc', 'killmails', [sa.text('time DESC')], unique=False)
    op.drop_index('idx_killmails_system_time', table_name='killmails', postgresql_ops={'time': 'DESC'})
    op.create_index('idx_killmails_system_time', 'killmails', ['system_id', sa.text('time DESC')], unique=False)
    op.drop_index('idx_killmails_corporation_time', table_name='killmails', postgresql_ops={'time': 'DESC'})
    op.create_index('idx_killmails_corporation_time', 'killmails', ['victim_corporation_id', sa.text('time DESC')], unique=False)
    op.drop_index('idx_killmails_character_time', table_name='killmails', postgresql_ops={'time': 'DESC'})
    op.create_index('idx_killmails_character_time', 'killmails', ['victim_character_id', sa.text('time DESC')], unique=False)
